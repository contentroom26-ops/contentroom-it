      ...
      */}
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between relative">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <Link
            to="/contatti"
            className={`ml-3 inline-flex items-center justify-center px-5 py-2.5 rounded-2xl font-body text-sm font-bold tracking-wide transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 hover:brightness-105 ${isLightSection ? "text-white bg-brand-orange" : "text-[hsl(192_35%_16%)] bg-primary"}`}
          >
            Prenota una call
          </Link>
        </div>
            ...
            <div className="flex flex-col items-center justify-center flex-1 gap-6 px-6 py-28">
              ...
              >
                <Link
                  to="/contatti"
                  onClick={closeMobile}
                  className={`flex items-center justify-center w-full px-6 py-4 rounded-2xl font-body text-base font-bold transition-all duration-300 active:scale-95 ${isLightSection ? "text-white bg-brand-orange" : "text-[hsl(192_35%_16%)] bg-primary"}`}
                >
                  Prenota una call
                </Link>
              </motion.div>
