...
const problems = [
  "Investi in ads ma non sai davvero quale sia il ritorno?",
  "Il traffico al sito non si traduce in vendite o contatti?",
  "Non hai una strategia di crescita, solo campagne isolate?",
];
...
const offerings = [
  {
    ...
    before:
      "Decisioni di marketing prese a intuito, senza dati a supportarle.",
    after:
      "Costruiamo la strategia partendo dai numeri: analisi del mercato, del pubblico e della concorrenza per indirizzare ogni investimento dove conta.",
  },
  {
    icon: Megaphone,
    num: "02",
    title: "Campagne Ads su Meta, Google e TikTok",
    before:
      "Budget pubblicitario speso senza un funnel chiaro, con risultati incostanti.",
    after:
      "Progettiamo e gestiamo campagne mirate su Meta, Google e TikTok, costruite su funnel di acquisizione pensati per convertire, non solo per generare visibilità.",
  },
  {
    icon: BarChart3,
    num: "03",
    title: "Monitoraggio e ottimizzazione del ROI",
    before:
      "Nessuna visibilità chiara su quanto rende davvero ogni euro investito.",
    after:
      "Monitoriamo ogni KPI in tempo reale e ottimizziamo le campagne costantemente, per massimizzare il ritorno sull'investimento, non solo il numero di click.",
  },
];
...
const steps = [
  {
    ...
    num: "01",
    name: "Analisi",
    desc: "Studiamo il mercato, il pubblico e i competitor per individuare le migliori opportunità di crescita.",
  },
  {
    icon: LineChart,
    num: "02",
    name: "Strategia e lancio",
    desc: "Costruiamo il funnel e lanciamo le campagne sui canali più adatti agli obiettivi del tuo business.",
  },
  {
    icon: TrendingUp,
    num: "03",
    name: "Ottimizzazione",
    desc: "Monitoriamo le performance e affiniamo le campagne costantemente per massimizzare i risultati.",
  },
];
...
const faqs = [
  {
    q: "Con quale budget minimo si può iniziare?",
    a: "Il budget pubblicitario va definito in base agli obiettivi e al settore. Nella call gratuita analizziamo la tua situazione e ti indichiamo un budget realistico per partire.",
  },
  {
    q: "Quanto tempo prima si vedono risultati?",
    a: "Le prime indicazioni sulle campagne arrivano già nelle prime settimane, ma una strategia di crescita solida si costruisce e si ottimizza nel tempo, generalmente su un orizzonte di alcuni mesi.",
  },
  {
    q: "Gestite anche il budget pubblicitario o solo la strategia?",
    a: "Gestiamo l'intero processo: strategia, creazione delle campagne, gestione del budget e ottimizzazione continua. Tu mantieni sempre visibilità completa sugli investimenti.",
  },
];

const GrowthMarketing = () => {
  const canonical = "https://www.contentroom.it/growth-marketing";

  return (
    <>
      <Helmet>
        {/* ⚠️ PERSONALIZZA — title e description per la SEO */}
        <title>Growth & Marketing: Campagne Ads e Strategia | Content Room — Firenze</title>
        <meta
          name="description"
          content="Strategie data-driven e campagne ads su Meta, Google e TikTok per scalare il tuo business online. Monitoriamo ogni KPI per massimizzare il ROI."
        />
        <link rel="canonical" href={canonical} />
        <meta property="og:title" content="Growth & Marketing | Content Room" />
        <meta
          property="og:description"
          content="Strategie data-driven e campagne ads su Meta, Google e TikTok per scalare il tuo business online."
        />
        ...
        <section className="section-dark pt-40 pb-20 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              >
                Ogni euro investito, misurato. <span className="text-primary">Ogni campagna, ottimizzata.</span>
              </h1>
              {/* ⚠️ PERSONALIZZA — sottotitolo */}
              <p className="font-body text-base md:text-lg max-w-2xl text-white/75">
                Strategie data-driven e campagne ads su Meta, Google e TikTok per scalare
                il tuo business online, con il ROI sempre sotto controllo.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="section-light py-20 md:py-28 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              >
                Fare ads non significa<br />
                <span className="text-primary">fare crescita.</span>
              </h2>
              ...
              <p className="font-body text-base md:text-lg leading-relaxed max-w-3xl text-[hsl(0_0%_25%)]">
                Content Room costruisce strategie di crescita data-driven, dove ogni
                campagna è misurata e ottimizzata per generare un ritorno reale.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="section-light py-20 md:py-28 px-6">
          ...
          >
            ...
            <h2
              ...
              style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)" }}
            >
              Scopri quanto puoi crescere con una strategia mirata.
            </h2>
            <p className="font-body text-base md:text-lg mb-4 max-w-xl mx-auto text-[hsl(0_0%_30%)]">
              Una call gratuita di 30 minuti per analizzare il tuo business e valutare
              le migliori opportunità di crescita. Nessun impegno.
            </p>
